...
public class WebSocketStreamPartByPartClient implements Runnable {

    private final String websocketURL;
    private Log log = LogFactory.getLog(WebSocketStreamPartByPartClient.class);

    public WebSocketStreamPartByPartClient(String websocketURL) {
    ...
    public void run() {
        ...
        try {
            URI url = new URI(websocketURL + "websocket-stream-parts");
